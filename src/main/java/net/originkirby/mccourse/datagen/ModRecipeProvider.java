package net.originkirby.mccourse.datagen;
...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        oreBlasting(consumer, ALEXANDRITE_SMELTABLES, RecipeCategory.MISC, ModItems.ALEXANDRITE.get(), 0.3f, 100, "alexandrite");
    ...
    protected static void oreCooking(Consumer<FinishedRecipe> pFinishedRecipeConsumer, RecipeSerializer<? extends net.minecraft.world.item.crafting.AbstractCookingRecipe> pCookingSerializer,
